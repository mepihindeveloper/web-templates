...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		function _set_interface() {
			...
			$('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + settings.imageLoading + '"></a></div></div></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"><img src="' + settings.imageBtnClose + '"></a></div></div>');	
			// Get page sizes
		...
		function _show_image() {
			...
			$('#lightbox-nav').css({
				width: $('img#lightbox-image').width()
			});
			$('#lightbox-nav').css({
				left: $(this).width()/4
			});
